...
int main()
{
    ...
    cout << QuickSelect(A, 0, 7, 8) << endl;
    cout << QuickSelect(A, 0, 7, 7) << endl;
    cout << QuickSelect(A, 0, 7, 6) << endl;
    cout << QuickSelect(A, 0, 7, 5) << endl;
    cout << QuickSelect(A, 0, 7, 4) << endl;
    cout << QuickSelect(A, 0, 7, 3) << endl;
    cout << QuickSelect(A, 0, 7, 2) << endl;
    cout << QuickSelect(A, 0, 7, 1) << endl;
